...
@NgModule({
  declarations: [GamePageComponent, PlacementComponent, HandComponent, DrawComponent, ShotComponent, MainScreenComponent, ShipsStateComponent, OpponentShotComponent],
  imports: [
    CommonModule,
